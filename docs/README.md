...
需要注意的是[本 repo](https://github.com/thuservices/thuservices) 中使用了 [pre-commit hook](https://github.com/thuservices/thuservices/blob/master/pre-commit)，请[安装](https://git-scm.com/book/zh/v2/%E8%87%AA%E5%AE%9A%E4%B9%89-Git-Git-%E9%92%A9%E5%AD%90)，并在有 bash 与 python3 的环境中进行 commit。

在 pre-commit hook 的作用下，README.md 是自动生成的，故如果需要在 README.md 中修改，请在 [misc 文件夹](https://github.com/thuservices/thuservices/tree/master/misc)下进行。
